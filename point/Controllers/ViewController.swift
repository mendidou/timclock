        ...
        class ViewController: UIViewController {
            ...
            override func viewDidLoad() {
                ...
                basicCircle = Circle(drawCircleWith: center, color: UIColor.trakStrokeColor.cgColor,
                                     fillcolor: UIColor.rgb(r: 0, g: 0, b: 0,alpha: 0.3).cgColor, at: view.center)
                    .addCircle(to: self.view)
                ...
                //check if a guard as started if so update the label interval time and actived the progess circle
        ...
        extension ViewController  {
            ...
            override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
               ...
               // run if the user dont have the location permission
                    if !LocationManager.shared.hasLocationPermision  {
                        LocationManager.shared.sendTooParameters(addto: self, texte: "please allow location permission in the setting before")
                    return
                    }
                    //run if the user is not at the office or don't have the location activated in the phone
                    if !LocationManager.shared.isIntheAuthorizedRegion {
                        LocationManager.shared.sendTooParameters(addto: self , texte: "your are not at the office or activate your location please")
                               return
                               }
